...
Draw.loadPlugin(function (ui) {
    ...
    C4Person.prototype.create = function () {
        ...
        body.setAttribute('label', '<div style="font-size:14px;font-weight:bold;">name</div><div>[Person]</div><div><br></div><div>Beschreibung</div>');
    ...
    C4SoftwareSystem.prototype.create = function () {
        ...
        c4SoftwareSystem.setAttribute('label', '<div style="font-size:14px;font-weight:bold;">name</div><div>[Software System]</div><div><br></div><div>Beschreibung</div>');
    ...
    C4Container.prototype.create = function () {
        ...
        c4Container.setAttribute('label', '<span><div style="font-size:14px;font-weight:bold;">name</div></span><div>[Container:&nbsp;<span>technology</span><span>]</span></div><div><br></div><div>Beschreibung</div>');
    ...
    C4Component.prototype.create = function () {
        ...
        c4Component.setAttribute('label', '<span><div style="font-size:14px;font-weight:bold;">name</div></span><div>[Component:&nbsp;<span>technology</span><span>]</span></div><div><br></div><div>Beschreibung</div>');
